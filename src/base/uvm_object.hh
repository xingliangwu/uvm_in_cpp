...
class uvm_object {
  ...
  // instance name.
    ...
    static const bool use_uvm_seeding = true;
  ...
  public:
    uvm_object(std::string name="") {m_inst_id = m_inst_count++; m_leaf_name = name;}
  ...
  // given name.
    ...
    virtual void set_name (std::string name) {m_leaf_name = name;}
  ...
  // <new> constructor or <set_name> method.
    ...
    virtual std::string get_name () {return m_leaf_name;}
  ...
  // Returns the object's unique, numeric instance identifier.
    ...
    virtual int get_inst_id () {return m_inst_id;}
  ...
  static int get_inst_count() {return m_inst_count;}
  ...
  //static uvm_object_wrapper get_type (){return null;}
  ...
  //virtual bit do_compare (uvm_object  rhs,
